...
\title{Computernetzwerke \\[0.3cm]
      --- CompTIA Network+ Vorbereitung---}
...
\begin{document}
\TitelDerArbeit{Computernetzwerke}
\UnterTitelDerArbeit{--- CompTIA Network+ Vorbereitung---}
\AutorDerArbeit{Patrick Müller}
\Kurs{}
